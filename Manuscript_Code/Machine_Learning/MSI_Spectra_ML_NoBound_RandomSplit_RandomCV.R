...
###########################
spectra_random_results <- foreach(n = n_seq, .combine = rbind) %:%
...
spectra_random_clean_results <- spectra_random_results %>%
  as_tibble() %>%
...
spectra_random_clean_results %>%
  write_csv(paste("../Results/spectra_randomsplit_randomcv_nobound_clean_", iter, ".csv", sep = ""))


spectra_random_results %>%
  as_tibble() %>%
  unnest(cols = everything()) %>%
  write_csv(paste("../Results/spectra_randomsplit_randomcv_nobound_raw_", iter, ".csv", sep = ""))
