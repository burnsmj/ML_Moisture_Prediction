...
```{r}
nir_spectra<-read.csv("../Data/Spectra_Data/NIR_spectra_w_moisture_uptake.csv", check.names = F)
...
```{r}
nir_test_spectra<-read.csv("../Data/Spectra_Data/WiDiv_Dataset_Inliers.csv", check.names = F)
